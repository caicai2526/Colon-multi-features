...
title('Train set Kaplan-Meier estimate of survival functions')
ylabel('Estimated survival functions')
xlabel('Time(months)')
if isempty(S3)
    legend([S1 S2],'short-term','long-term')
else
    legend([S1 S2 S3],'short-term','long-term','Censored')
end
...
text(1,0.2,['p-value=',num2str(p)],'FontSize',14);
%display results
